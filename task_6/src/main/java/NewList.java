...
public class NewList<E> implements List<E> {
    ...
    /**
     * Text constant illegal capacity
     */
    ...
    /**
     * Trims the capacity of this list instance
     */
     ...
     *
     * @param minCapacity is minimum capacity
     */
    ...
    private class Itr implements ListIterator<E> {
        ...
        public E next() {
            ...
            Object[] elementData = NewList.this.elementData;
        ...
        public void forEachRemaining(Consumer<? super E> consumer) {
            ...
            final Object[] elementData = NewList.this.elementData;
            if (i >= elementData.length) {
                throw new ConcurrentModificationException();
            }
